...
def render_metric_card(title: str, value: str):
    st.markdown(
        ...
        <div class="metric-card">
            <div style="font-size:0.95rem; color: var(--text-color); opacity: 0.7; margin-bottom:6px;">{title}</div>
            <div style="font-size:2rem; font-weight:700; color: var(--text-color);">{value}</div>
        </div>
        """,
        unsafe_allow_html=True
    )
                        ...
                        for i, text in enumerate(unique_reviews, start=1):
                            st.markdown(
                                ...
                                <div class="source-card">
                                    <div style="font-weight:700; color: var(--text-color); margin-bottom:10px;">Source {i}</div>
